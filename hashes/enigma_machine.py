...
reflector = [i for i in reversed(list(range(len(alphabets))))]
code = []
...
if __name__ == "__main__":
    decode = list(eval(input("Type your message:\n")))
    while True:
        try:
            token = int(eval(input("Please set token:(must be only digits)\n")))
            break
